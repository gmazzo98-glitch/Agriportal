...
LOW   = "background-color: rgba(79,138,91,0.30);  color:#4f8a5b; font-weight:600"   # healthy
MED   = "background-color: rgba(181,138,50,0.35);  color:#9a7322; font-weight:600"   # caution
HIGH  = "background-color: rgba(192,87,58,0.40);  color:#c0573a; font-weight:600"   # severe

# Subtle whole-row match — background wash only, text left to the theme ink.
MATCH = "background-color: rgba(79,138,91,0.20)"

# Neutral emphasis (totals / selected) — slate azure.
NEUTRAL = "background-color: rgba(63,125,156,0.30); color:#6f9cb3; font-weight:600"
